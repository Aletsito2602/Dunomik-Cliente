...
class UsersRecord extends FirestoreRecord {
  ...
  Map<String, DebugDataField> toDebugSerializableMap() => {
        ...
        'challenges_active': debugSerializeParam(
          challengesActive,
          ParamType.bool,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'kyc_status': debugSerializeParam(
          kycStatus,
          ParamType.bool,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'referidos_list': debugSerializeParam(
          referidosList,
          ParamType.DocumentReference,
          isList: true,
          link:
        ...
        'acepta_terminos': debugSerializeParam(
          aceptaTerminos,
          ParamType.bool,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'acepta_paisderecidencia': debugSerializeParam(
        ...
        'withdrawals_wallet': debugSerializeParam(
          withdrawalsWallet,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'wallet_server': debugSerializeParam(
          walletServer,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'ib_comisiions': debugSerializeParam(
          ibComisiions,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'direccion_acc': debugSerializeParam(
          direccionAcc,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'emailuser_verified': debugSerializeParam(
          emailuserVerified,
          ParamType.bool,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'codigodereferido': debugSerializeParam(
          codigodereferido,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'referente1': debugSerializeParam(
          referente1,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'referente2': debugSerializeParam(
          referente2,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
