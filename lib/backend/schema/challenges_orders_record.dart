...
class ChallengesOrdersRecord extends FirestoreRecord {
  ...
  Map<String, DebugDataField> toDebugSerializableMap() => {
        ...
        'typeofaccount': debugSerializeParam(
          typeofaccount,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'amountofaccount': debugSerializeParam(
          amountofaccount,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'plattformselected': debugSerializeParam(
          plattformselected,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'email_buyer': debugSerializeParam(
          emailBuyer,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'hash_orders': debugSerializeParam(
          hashOrders,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'name_buyer': debugSerializeParam(
          nameBuyer,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'time_order': debugSerializeParam(
          timeOrder,
          ParamType.DateTime,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'referente3': debugSerializeParam(
          referente3,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
