...
class ChallengeDetailsRecord extends FirestoreRecord {
  ...
  Map<String, DebugDataField> toDebugSerializableMap() => {
        ...
        'chart_data': debugSerializeParam(
          chartData,
          ParamType.String,
          isList: true,
          link:
        ...
        'chart_labels': debugSerializeParam(
          chartLabels,
          ParamType.String,
          isList: true,
          link:
        ...
        'acc_balance_now': debugSerializeParam(
          accBalanceNow,
          ParamType.double,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'acc_day_now': debugSerializeParam(
          accDayNow,
          ParamType.int,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
