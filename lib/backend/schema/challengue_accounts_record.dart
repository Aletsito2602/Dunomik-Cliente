...
class ChallengueAccountsRecord extends FirestoreRecord {
  ...
  Map<String, DebugDataField> toDebugSerializableMap() => {
        'reference': debugSerializeParam(
          ...
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
          name: '',
          nullable: false,
        ),
        'id_account': debugSerializeParam(
          idAccount,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'plataforma': debugSerializeParam(
          plataforma,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'end_account': debugSerializeParam(
          endAccount,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'account_size': debugSerializeParam(
          accountSize,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'lastupdate': debugSerializeParam(
          lastupdate,
          ParamType.DateTime,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'minimun_trading_acc': debugSerializeParam(
          minimunTradingAcc,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'max_daily_loss': debugSerializeParam(
          maxDailyLoss,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'profit_targeet': debugSerializeParam(
          profitTargeet,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'equity_account': debugSerializeParam(
          equityAccount,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'balance_account': debugSerializeParam(
          balanceAccount,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'account_email_user': debugSerializeParam(
          accountEmailUser,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'server_Account': debugSerializeParam(
          serverAccount,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'password_account': debugSerializeParam(
          passwordAccount,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'challenge_type': debugSerializeParam(
          challengeType,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'balance_type': debugSerializeParam(
          balanceType,
          ParamType.bool,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'CurrentEquity': debugSerializeParam(
          currentEquity,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'CurrentProfit': debugSerializeParam(
          currentProfit,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'mtd_status': debugSerializeParam(
          mtdStatus,
          ParamType.bool,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'mdl_status': debugSerializeParam(
          mdlStatus,
          ParamType.bool,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'start_date': debugSerializeParam(
          startDate,
          ParamType.DateTime,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'can_witdhawral': debugSerializeParam(
          canWitdhawral,
          ParamType.bool,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'amaount_withdrawal': debugSerializeParam(
          amaountWithdrawal,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'account_type': debugSerializeParam(
          accountType,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'challenge_balance': debugSerializeParam(
          challengeBalance,
          ParamType.double,
          isList: true,
          link:
        ...
        'challenge_day': debugSerializeParam(
          challengeDay,
          ParamType.double,
          isList: true,
          link:
