...
class KycRecord extends FirestoreRecord {
  ...
  Map<String, DebugDataField> toDebugSerializableMap() => {
        ...
        'Dateofbirth': debugSerializeParam(
          dateofbirth,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'Occupation': debugSerializeParam(
          occupation,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'Employment': debugSerializeParam(
          employment,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'SourceofFunds': debugSerializeParam(
          sourceofFunds,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
