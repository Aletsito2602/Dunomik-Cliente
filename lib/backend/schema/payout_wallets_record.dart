...
class PayoutWalletsRecord extends FirestoreRecord {
  ...
  Map<String, DebugDataField> toDebugSerializableMap() => {
        ...
        'hft_trc_wallet': debugSerializeParam(
          hftTrcWallet,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'hft_bep20_wallet': debugSerializeParam(
          hftBep20Wallet,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'standard_trc20_wallet': debugSerializeParam(
          standardTrc20Wallet,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'standard_bep20_wallet': debugSerializeParam(
          standardBep20Wallet,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'hft_trc_wallet_qr': debugSerializeParam(
          hftTrcWalletQr,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
        ...
        'hft_bep20_wallet_qt': debugSerializeParam(
          hftBep20WalletQt,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/dunomik-xzjamm?tab=database',
