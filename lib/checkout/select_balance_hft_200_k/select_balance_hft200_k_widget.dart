...
import 'select_balance_hft200_k_model.dart';
export 'select_balance_hft200_k_model.dart';
...
class SelectBalanceHft200KWidget extends StatefulWidget {
  ...
  final DocumentReference? hft200;
...
class _SelectBalanceHft200KWidgetState extends State<SelectBalanceHft200KWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CuponRecord>(
      stream: CuponRecord.getDocument(widget!.hft200!),
      builder: (context, snapshot) {
        ...
        _model.debugBackendQueries[
                'selectBalanceHft200KCuponRecord_Scaffold_fzwdl4wd'] =
            debugSerializeParam(
