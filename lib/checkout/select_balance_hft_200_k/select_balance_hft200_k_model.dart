...
import 'select_balance_hft200_k_widget.dart' show SelectBalanceHft200KWidget;
...
class SelectBalanceHft200KModel
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        widgetParameters: {
          'hft200': debugSerializeParam(
            widget?.hft200,
            ParamType.DocumentReference,
            link:
                'https://app.flutterflow.io/project/dunomik-xzjamm?tab=uiBuilder&page=select-balance-hft-200K',
            searchReference:
                'reference=SiEKEAoGaGZ0MjAwEgZoY2Y4YXdyDQgGKgkKBwoFQ1VQT05QAVoGaGZ0MjAw',
            name: 'CUPON',
            nullable: true,
          )
        }.withoutNulls,
        ...
        link:
            'https://app.flutterflow.io/project/dunomik-xzjamm/tab=uiBuilder&page=select-balance-hft-200K',
        searchReference:
            'reference=OhdzZWxlY3QtYmFsYW5jZS1oZnQtMjAwS1ABWhdzZWxlY3QtYmFsYW5jZS1oZnQtMjAwSw==',
        widgetClassName: 'select-balance-hft-200K',
      );
}
