...
import 'select_balance_standard100k_widget.dart'
    show SelectBalanceStandard100kWidget;
...
class SelectBalanceStandard100kModel
    extends FlutterFlowModel<SelectBalanceStandard100kWidget> {
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        link:
            'https://app.flutterflow.io/project/dunomik-xzjamm/tab=uiBuilder&page=select-balance-standard-100k',
        searchReference:
            'reference=OhxzZWxlY3QtYmFsYW5jZS1zdGFuZGFyZC0xMDBrUAFaHHNlbGVjdC1iYWxhbmNlLXN0YW5kYXJkLTEwMGs=',
        widgetClassName: 'select-balance-standard-100k',
      );
}
