...
import 'select_balance_standard25k_widget.dart'
    show SelectBalanceStandard25kWidget;
...
class SelectBalanceStandard25kModel
    extends FlutterFlowModel<SelectBalanceStandard25kWidget> {
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        link:
            'https://app.flutterflow.io/project/dunomik-xzjamm/tab=uiBuilder&page=select-balance-standard-25k',
        searchReference:
            'reference=OhtzZWxlY3QtYmFsYW5jZS1zdGFuZGFyZC0yNWtQAVobc2VsZWN0LWJhbGFuY2Utc3RhbmRhcmQtMjVr',
        widgetClassName: 'select-balance-standard-25k',
      );
}
