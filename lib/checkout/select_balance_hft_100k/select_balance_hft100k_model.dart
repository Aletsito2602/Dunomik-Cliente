...
class SelectBalanceHft100kModel
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        widgetParameters: {
          'hft100': debugSerializeParam(
            widget?.hft100,
            ParamType.DocumentReference,
            link:
                'https://app.flutterflow.io/project/dunomik-xzjamm?tab=uiBuilder&page=select-balance-hft-100k',
            searchReference:
                'reference=SiEKEAoGaGZ0MTAwEgZld20xYW9yDQgGKgkKBwoFQ1VQT05QAVoGaGZ0MTAw',
            name: 'CUPON',
            nullable: true,
          )
        }.withoutNulls,
        ...
        link:
            'https://app.flutterflow.io/project/dunomik-xzjamm/tab=uiBuilder&page=select-balance-hft-100k',
        searchReference:
            'reference=OhdzZWxlY3QtYmFsYW5jZS1oZnQtMTAwa1ABWhdzZWxlY3QtYmFsYW5jZS1oZnQtMTAwaw==',
        widgetClassName: 'select-balance-hft-100k',
      );
}
