...
import 'select_balance_standard10k_widget.dart'
    show SelectBalanceStandard10kWidget;
...
class SelectBalanceStandard10kModel
    extends FlutterFlowModel<SelectBalanceStandard10kWidget> {
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        link:
            'https://app.flutterflow.io/project/dunomik-xzjamm/tab=uiBuilder&page=select-balance-standard-10k',
        searchReference:
            'reference=OhtzZWxlY3QtYmFsYW5jZS1zdGFuZGFyZC0xMGtQAVobc2VsZWN0LWJhbGFuY2Utc3RhbmRhcmQtMTBr',
        widgetClassName: 'select-balance-standard-10k',
      );
}
