...
import 'select_balance_standard50k_widget.dart'
    show SelectBalanceStandard50kWidget;
...
class SelectBalanceStandard50kModel
    extends FlutterFlowModel<SelectBalanceStandard50kWidget> {
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        link:
            'https://app.flutterflow.io/project/dunomik-xzjamm/tab=uiBuilder&page=select-balance-standard-50k',
        searchReference:
            'reference=OhtzZWxlY3QtYmFsYW5jZS1zdGFuZGFyZC01MGtQAVobc2VsZWN0LWJhbGFuY2Utc3RhbmRhcmQtNTBr',
        widgetClassName: 'select-balance-standard-50k',
      );
}
