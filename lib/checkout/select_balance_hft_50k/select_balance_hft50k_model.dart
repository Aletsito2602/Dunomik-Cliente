...
class SelectBalanceHft50kModel
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        link:
            'https://app.flutterflow.io/project/dunomik-xzjamm/tab=uiBuilder&page=select-balance-hft-50k',
        searchReference:
            'reference=OhZzZWxlY3QtYmFsYW5jZS1oZnQtNTBrUAFaFnNlbGVjdC1iYWxhbmNlLWhmdC01MGs=',
        widgetClassName: 'select-balance-hft-50k',
      );
}
