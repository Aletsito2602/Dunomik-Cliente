...
class SelectBalanceHft25kModel
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        link:
            'https://app.flutterflow.io/project/dunomik-xzjamm/tab=uiBuilder&page=select-balance-hft-25k',
        searchReference:
            'reference=OhZzZWxlY3QtYmFsYW5jZS1oZnQtMjVrUAFaFnNlbGVjdC1iYWxhbmNlLWhmdC0yNWs=',
        widgetClassName: 'select-balance-hft-25k',
      );
}
