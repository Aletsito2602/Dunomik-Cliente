...
class SelectBalanceHft10kWidget extends StatefulWidget {
  const SelectBalanceHft10kWidget({
    super.key,
    this.addModelFn,
    this.hft10,
  });

  final DocumentReference? hft10;
...
class _SelectBalanceHft10kWidgetState extends State<SelectBalanceHft10kWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CuponRecord>(
      stream: CuponRecord.getDocument(widget!.hft10!),
      builder: (context, snapshot) {
        ...
        final selectBalanceHft10kCuponRecord = snapshot.data!;
        _model.debugBackendQueries[
                'selectBalanceHft10kCuponRecord_Scaffold_90i1icrb'] =
            debugSerializeParam(
          selectBalanceHft10kCuponRecord,
          ParamType.Document,
          link:
