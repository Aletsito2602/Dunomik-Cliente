...
class SelectBalanceHft10kModel
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        link:
            'https://app.flutterflow.io/project/dunomik-xzjamm/tab=uiBuilder&page=select-balance-hft-10k',
        searchReference:
            'reference=OhZzZWxlY3QtYmFsYW5jZS1oZnQtMTBrUAFaFnNlbGVjdC1iYWxhbmNlLWhmdC0xMGs=',
        widgetClassName: 'select-balance-hft-10k',
      );
}
