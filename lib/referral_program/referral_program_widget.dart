...
class ReferralProgramWidget extends StatefulWidget {
  const ReferralProgramWidget({super.key, this.addModelFn});
                                                                    ...
                                                                    children: [
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            await Clipboard.setData(ClipboardData(text: 'portal-dunomik.com/register?ref=${currentUserUid}'));
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        valueOrDefault<
                                                                            String>(
                                                                          valueOrDefault(
                                                                              currentUserDocument?.ibComisiions,
                                                                              ''),
                                                                          '0',
                                                                        ),
                                                                        style: FlutterFlowTheme.of(context)
                                            ...
                                            child: StreamBuilder<
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                _model.debugBackendQueries[
                                                        'listViewUsersRecordList_ListView_a3ebl2ft${listViewUsersRecordList.length > 100 ? ' (first 100)' : ''}'] =
                                                    debugSerializeParam(
                                                  listViewUsersRecordList
                                                      .take(100),
                                                  ParamType.Document,
