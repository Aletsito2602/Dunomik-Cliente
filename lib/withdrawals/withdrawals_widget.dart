...
class WithdrawalsWidget extends StatefulWidget {
  const WithdrawalsWidget({super.key, this.addModelFn});
                                                                            ...
                                                                            Expanded(
                                                                              child: StreamBuilder<List<ChallengueAccountsRecord>>(
                                                                                ...
                                                                                builder: (context, snapshot) {
                                                                                  ...
                                                                                  _model.debugBackendQueries['listViewChallengueAccountsRecordList_ListView_dmpc2cy4${listViewChallengueAccountsRecordList.length > 100 ? ' (first 100)' : ''}'] = debugSerializeParam(
                                                                                    listViewChallengueAccountsRecordList.take(100),
                                                                                    ParamType.Document,
                                                                                    isList: true,
                                                                                    link: 'https://app.flutterflow.io/project/dunomik-xzjamm?tab=uiBuilder&page=Withdrawals',
                                                                            ...
                                                                            Expanded(
                                                                              child: StreamBuilder<List<ChallengueAccountsRecord>>(
                                                                                ...
                                                                                builder: (context, snapshot) {
                                                                                  ...
                                                                                  _model.debugBackendQueries['listViewChallengueAccountsRecordList_ListView_k2431ek5${listViewChallengueAccountsRecordList.length > 100 ? ' (first 100)' : ''}'] = debugSerializeParam(
                                                                                    listViewChallengueAccountsRecordList.take(100),
                                                                                    ParamType.Document,
                                                                                    isList: true,
                                                                                    link: 'https://app.flutterflow.io/project/dunomik-xzjamm?tab=uiBuilder&page=Withdrawals',
                                            ...
                                            StreamBuilder<
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                _model.debugBackendQueries[
                                                        'listViewWithdrawhalTicketRecordList_ListView_nx2i30kf${listViewWithdrawhalTicketRecordList.length > 100 ? ' (first 100)' : ''}'] =
                                                    debugSerializeParam(
                                                  listViewWithdrawhalTicketRecordList
                                                      .take(100),
                                                  ParamType.Document,
