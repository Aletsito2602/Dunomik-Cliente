...
class NewChallengeCopyModel extends FlutterFlowModel<NewChallengeCopyWidget> {
  ...
  ApiCallResponse? _apiResultkpe;
  set apiResultkpe(ApiCallResponse? value) {
    _apiResultkpe = value;
    debugLogWidgetClass(rootModel);
  }

  ApiCallResponse? get apiResultkpe => _apiResultkpe;
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        actionOutputs: {
          'apiResultkpe': debugSerializeParam(
            apiResultkpe,
        ...
        link:
            'https://app.flutterflow.io/project/dunomik-xzjamm/tab=uiBuilder&page=NewChallengeCopy',
        searchReference:
            'reference=OhBOZXdDaGFsbGVuZ2VDb3B5UAFaEE5ld0NoYWxsZW5nZUNvcHk=',
        widgetClassName: 'NewChallengeCopy',
      );
}
