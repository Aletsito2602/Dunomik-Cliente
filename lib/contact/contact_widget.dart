...
class ContactWidget extends StatefulWidget {
  const ContactWidget({super.key, this.addModelFn});
...
class _ContactWidgetState extends State<ContactWidget> with RouteAware {
                                                                        ...
                                                                        children: [
                                                                          Expanded(
                                                                            child:
                                                                              ...
                                                                              obscureText: false,
                                                                              decoration: InputDecoration(
                                                                                labelText: 'Tell us, what is the problem?',
                                                                                labelStyle: FlutterFlowTheme.of(context).labelMedium.override(
                                                                                      fontFamily: FlutterFlowTheme.of(context).labelMediumFamily,
                                                                                      letterSpacing: 0.0,
                                                                                      useGoogleFonts: GoogleFonts.asMap().containsKey(FlutterFlowTheme.of(context).labelMediumFamily),
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          await SupportTicketsRecord
                                                                              ...
                                                                              .set(createSupportTicketsRecordData(
                                                                                ...
                                                                                nameTicket: currentUserDisplayName,
