...
import 'new_challenge_copy_copy2_model.dart';
export 'new_challenge_copy_copy2_model.dart';

class NewChallengeCopyCopy2Widget extends StatefulWidget {
  const NewChallengeCopyCopy2Widget({super.key, this.addModelFn});

  final Function(FlutterFlowModel)? addModelFn;

  @override
  State<NewChallengeCopyCopy2Widget> createState() =>
      _NewChallengeCopyCopy2WidgetState();
}

class _NewChallengeCopyCopy2WidgetState
    extends State<NewChallengeCopyCopy2Widget>
    with TickerProviderStateMixin, RouteAware {
  late NewChallengeCopyCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewChallengeCopyCopy2Model());
