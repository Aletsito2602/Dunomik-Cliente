...
class RegisterModel extends FlutterFlowModel<RegisterWidget> {
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        widgetParameters: {
          'ref': debugSerializeParam(
            widget?.ref,
            ParamType.String,
            link:
                'https://app.flutterflow.io/project/dunomik-xzjamm?tab=uiBuilder&page=Register',
            searchReference:
                'reference=ShUKDQoDcmVmEgZ4aWYzdHJyBAgDIAFQAVoDcmVm',
            name: 'String',
            nullable: true,
          )
        }.withoutNulls,
        widgetStates: {
          'customerNameText': debugSerializeParam(
          ...
          'customerLastNameText': debugSerializeParam(
            customerLastNameTextController?.text,
            ParamType.String,
            link:
                'https://app.flutterflow.io/project/dunomik-xzjamm?tab=uiBuilder&page=Register',
            name: 'String',
          ...
          'cuponCodeText': debugSerializeParam(
            cuponCodeTextController?.text,
            ParamType.String,
            link:
                'https://app.flutterflow.io/project/dunomik-xzjamm?tab=uiBuilder&page=Register',
            name: 'String',
          ...
          'countryText': debugSerializeParam(
          ...
          'countryCodeText': debugSerializeParam(
          ...
          'customerNumberText': debugSerializeParam(
        ...
        link:
            'https://app.flutterflow.io/project/dunomik-xzjamm/tab=uiBuilder&page=Register',
        searchReference: 'reference=OghSZWdpc3RlclABWghSZWdpc3Rlcg==',
        widgetClassName: 'Register',
      );
}
