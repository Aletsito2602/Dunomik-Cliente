...
class OrdersWidget extends StatefulWidget {
  const OrdersWidget({super.key, this.addModelFn});
                                                                              ...
                                                                              Expanded(
                                                                                child: StreamBuilder<List<ChallengueAccountsRecord>>(
                                                                                  ...
                                                                                  builder: (context, snapshot) {
                                                                                    ...
                                                                                    _model.debugBackendQueries['listViewChallengueAccountsRecordList_ListView_727whlar${listViewChallengueAccountsRecordList.length > 100 ? ' (first 100)' : ''}'] = debugSerializeParam(
                                                                                      listViewChallengueAccountsRecordList.take(100),
                                                                                      ParamType.Document,
                                                                                      isList: true,
                                                                                      link: 'https://app.flutterflow.io/project/dunomik-xzjamm?tab=uiBuilder&page=Orders',
                                                                    ...
                                                                    child: PagedListView<
                                                                      ...
                                                                      builderDelegate:
                                                                        ...
                                                                        itemBuilder: (context,
                                                                            _,
                                                                            listViewIndex) {
                                                                          final listViewChallengesOrdersRecord = _model
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: Column(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Text(
                                                                                      dateTimeFormat("d/M H:mm", listViewChallengesOrdersRecord.timeOrder!),
                                                                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                            fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                            color: FlutterFlowTheme.of(context).success,
                                                                                            fontSize: 16.0,
                                                                  ...
                                                                  Visibility(
                                                                    ...
                                                                    child: StreamBuilder<
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        _model.debugBackendQueries['listViewSupportTicketsRecordList_ListView_ctq7p0ge${listViewSupportTicketsRecordList.length > 100 ? ' (first 100)' : ''}'] =
                                                                            debugSerializeParam(
                                                                          listViewSupportTicketsRecordList
                                                                              .take(100),
                                                                          ParamType
                                                                        ...
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              _model.debugBackendQueries['listViewChallengueAccountsRecordList_ListView_vy8hek6m${listViewChallengueAccountsRecordList.length > 100 ? ' (first 100)' : ''}'] = debugSerializeParam(
                                                                                listViewChallengueAccountsRecordList.take(100),
                                                                                ParamType.Document,
                                                                                isList: true,
                                                                                link: 'https://app.flutterflow.io/project/dunomik-xzjamm?tab=uiBuilder&page=Orders',
